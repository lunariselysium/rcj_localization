...
def generate_launch_description():
    ...
    launch_arguments = [
        ...
        DeclareLaunchArgument("use_fake_yaw", default_value="false"),  # Publish fake yaw instead of subscribing
        ...
        DeclareLaunchArgument("enable_topdown_pf_localization_node", default_value="true"),  # Start the topdown particle filter node
